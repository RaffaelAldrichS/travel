    ...
    <div class="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <form method="POST" action="{{ route('destinations.update', $destination->id) }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                ...
                <div>
                    ...
                    <input type="number" id="entrance_fee" name="entrance_fee"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        value="{{ $destination->entrance_fee }}" required />
                </div>
            </div>
            <div class="mb-5">
                ...
                <input
                    ...
                    aria-describedby="file_input_help" id="dropzone-file" type="file" name="image"
            ...
            <div id="image-preview" class="mb-5">
                <img src="{{ asset('storage/images/destinations/' . $destination->image) }}" class="h-64 object-contain rounded-lg">
            </div>
            <button type="submit"
                class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2 me-2 dark:focus:ring-yellow-900">Update</button>
        </form>
    </div>
